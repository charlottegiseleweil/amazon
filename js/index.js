...
function loadMapFiles() {
    readJsonFile("assets/data/amazon/Agricultura.json", function (text) {
        ...
        topoLayer[0].bindTooltip('<span class="square-tooltip agriculture">&nbsp</span> Agriculture');
    ...
    readJsonFile("assets/data/amazon/Agua.json", function (text) {
        ...
        topoLayer[1].bindTooltip('<span class="square-tooltip water">&nbsp</span> Water');
    ...
    readJsonFile("assets/data/amazon/Aguajal.json", function (text) {
        ...
        topoLayer[2].bindTooltip('<span class="square-tooltip swamp">&nbsp</span> Swamp');
    ...
    readJsonFile("assets/data/amazon/Bosque_inundable.json", function (text) {
        ...
        topoLayer[3].bindTooltip('<span class="square-tooltip floodable_forest">&nbsp</span> Floodable Forest');
    ...
    readJsonFile("assets/data/amazon/Bosque_montano.json", function (text) {
        ...
        topoLayer[4].bindTooltip('<span class="square-tooltip mountain_forest">&nbsp</span> Mountain Forest');
    ...
    readJsonFile("assets/data/amazon/Bosque_no_inundable.json", function (text) {
        ...
        topoLayer[5].bindTooltip('<span class="square-tooltip non_floodable_forest">&nbsp</span> Non Floodable Forest');
    ...
    readJsonFile("assets/data/amazon/Carreteras_no_pavimentadas.json", function (text) {
        ...
        topoLayer[6].bindTooltip('<span class="square-tooltip unpaved_roads">&nbsp</span> Unpaved Roads');
    ...
    readJsonFile("assets/data/amazon/Carreteras_pavimentadas.json", function (text) {
        ...
        topoLayer[7].bindTooltip('<span class="square-tooltip paved_roads">&nbsp</span> Paved Roads');
    ...
    readJsonFile("assets/data/amazon/Glaciar.json", function (text) {
        ...
        topoLayer[8].bindTooltip('<span class="square-tooltip glacier">&nbsp</span> Glacier');
    ...
    readJsonFile("assets/data/amazon/Humedales.json", function (text) {
        ...
        topoLayer[10].bindTooltip('<span class="square-tooltip wetland">&nbsp</span> Wetland');
    ...
    readJsonFile("assets/data/amazon/Matorral.json", function (text) {
        ...
        topoLayer[11].bindTooltip('<span class="square-tooltip thicket">&nbsp</span> Thicket');
    ...
    readJsonFile("assets/data/amazon/Mineria.json", function (text) {
        ...
        topoLayer[12].bindTooltip('<span class="square-tooltip mining">&nbsp</span> Mining');
    ...
    readJsonFile("assets/data/amazon/Pajonal_andino.json", function (text) {
        ...
        topoLayer[13].bindTooltip('<span class="square-tooltip andean_scrubland">&nbsp</span> Andean Scrubland');
    ...
    readJsonFile("assets/data/amazon/Pasto-Agricultura.json", function (text) {
        ...
        topoLayer[14].bindTooltip('<span class="square-tooltip agriculture_grass">&nbsp</span> Agriculture Grass');
    ...
    readJsonFile("assets/data/amazon/Pasto-Herbazal.json", function (text) {
        ...
        topoLayer[15].bindTooltip('<span class="square-tooltip pasture_grass">&nbsp</span> Pasture Grass');
    ...
    readJsonFile("assets/data/amazon/Pasto.json", function (text) {
        ...
        topoLayer[16].bindTooltip('<span class="square-tooltip grass">&nbsp</span> Grass');
    ...
    readJsonFile("assets/data/amazon/Pedregales.json", function (text) {
        ...
        topoLayer[17].bindTooltip('<span class="square-tooltip rocky_ground">&nbsp</span> Rocky Ground');
    ...
    readJsonFile("assets/data/amazon/Sabana_humedales.json", function (text) {
        ...
        topoLayer[19].bindTooltip('<span class="square-tooltip wet_savannah">&nbsp</span> Wet Savannah');
    ...
    readJsonFile("assets/data/amazon/Suelo_desnudo.json", function (text) {
        ...
        topoLayer[20].bindTooltip('<span class="square-tooltip naked_land">&nbsp</span> Naked Land');
    ...
    readJsonFile("assets/data/amazon/Urbano.json", function (text) {
        ...
        topoLayer[21].bindTooltip('<span class="square-tooltip urban">&nbsp</span> Urban');
    ...
    readJsonFile("assets/data/amazon/Vegetacion_secundaria.json", function (text) {
        ...
        topoLayer[22].bindTooltip('<span class="square-tooltip secondary_vegetation">&nbsp</span> Secondary Vegetation');
