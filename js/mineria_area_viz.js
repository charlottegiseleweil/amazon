    ...
    .get(function(response) {
      ...
      let showLeggend = function() {
        svg
          ...
          .attr("transform", "translate(" + padding / 2 + "," + h / 2 + ")")
          .text(function(d) {
      ...
      svg
        ...
        .on("click", function(d) {
          ...
          for (let key in SELECTION) {
            if (key === typeKey) {
              ...
              for (let sectorKey in SELECTION[key].sector) {
                if (
                  (key === "hm" && sectorKey === "pampa") ||
                  (key === "sp" && sectorKey === "huepetuhe")
                ) {
          ...
          areaStack.keys(keysOfThisType).value(function value(d, key) {
          ...
          svg
            ...
            .on("click", function(d) {
              ...
              // Set the selection variables
              let typeKey = thisType
                .substr(0, thisType.indexOf(" "))
                .match(/[A-Z]/g)
                .join("")
                .toLowerCase();
              let sectorKey = thisType
                .substr(thisType.indexOf(" ") + 1)
                .replace(" ", "")
                .toLowerCase();
      ...
      svg
        ...
        .attr(
          "transform",
          "translate(" + (w - padding) + "," + h / 2 + ")rotate(-90)"
        )
        .text("Area hm");
