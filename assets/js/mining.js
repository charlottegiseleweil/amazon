...
window.onload = () => {
    ...
    const customOption1 = L.Control.extend({
        ...
        onAdd: function(map) {
            ...
            container.onclick = function() {
                ...
                SELECTION.hm.categoryLevel = spSelected
                    ? sectorSelected
                        ? 2
                        : 1
                    : 1;
    ...
    const customOption2 = L.Control.extend({
        ...
        onAdd: function(map) {
            ...
            container.onclick = () => {
                ...
                SELECTION.sp.categoryLevel = spSelected
                    ? sectorSelected
                        ? 2
                        : 1
                    : 1;
    ...
    document
        ...
        .addEventListener("click", goBackToTop);
    loadMapFiles();
...
function loadMapFiles() {
    ...
    readJsonFile("assets/data/V5/grouped_mineria_1985-1993.json", function(
        text
    ) {
        let data = JSON.parse(text);
    ...
    readJsonFile(
        "assets/data/simplified_topo_simplified_geo_grouped_mineria_1993-2001.json",
        function(text) {
            let data = JSON.parse(text);
    ...
    readJsonFile(
        "assets/data/simplified_topo_simplified_geo_grouped_mineria_2001-2009.json",
        function(text) {
            let data = JSON.parse(text);
    ...
    readJsonFile(
        "assets/data/simplified_topo_simplified_geo_grouped_mineria_2009-2017.json",
        function(text) {
            let data = JSON.parse(text);
...
function updateButtonColors() {
    ...
    let buttons = document.querySelectorAll(
        ".leaflet-horizontal-right .button"
    );
