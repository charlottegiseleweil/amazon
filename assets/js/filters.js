...
function setFilterEvents() {
    ...
    document.getElementById("check-floodable_forest").addEventListener("click", handleCheckboxClick);
    ...
    document.getElementById("check-andean_scrubland").addEventListener("click", handleCheckboxClick);
    document.getElementById("check-grass").addEventListener("click", handleCheckboxClick);
